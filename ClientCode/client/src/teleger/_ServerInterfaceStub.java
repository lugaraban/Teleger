...
public class _ServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements teleger.ServerInterface
{
  ...
  public void notifyAnswerRequest (String connectedUser, String pass, String friend, boolean acceptance)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("notifyAnswerRequest", true);
                $out.write_string (connectedUser);
                $out.write_string (pass);
                $out.write_string (friend);
                $out.write_boolean (acceptance);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                notifyAnswerRequest (connectedUser, pass, friend, acceptance        );
            } finally {
                _releaseReply ($in);
            }
  } // notifyAnswerRequest
  ...
  public boolean changePassword (String old, String _new, String user)
  {
            ...
            try {
                ...
                $out.write_string (old);
                $out.write_string (_new);
                ...
                return changePassword (old, _new, user        );
            } finally {
                _releaseReply ($in);
            }
  } // changePassword
