 ...
 implements teleger.ServerInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("searchNewFriends", new java.lang.Integer (4));
    _methods.put ("sendRequestForFriend", new java.lang.Integer (5));
    _methods.put ("notifyAnswerRequest", new java.lang.Integer (6));
    _methods.put ("changePassword", new java.lang.Integer (7));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // teleger/ServerInterface/unRegister
       {
         String userId = in.read_string ();
         String userPassword = in.read_string ();
         boolean $result = false;
         $result = this.unRegister (userId, userPassword);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 4:  // teleger/ServerInterface/searchNewFriends
       {
       ...
       case 5:  // teleger/ServerInterface/sendRequestForFriend
       {
       ...
       case 6:  // teleger/ServerInterface/notifyAnswerRequest
       {
       ...
       case 7:  // teleger/ServerInterface/changePassword
       {
